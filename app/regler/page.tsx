  ...
  return <>
    ...
    <div className="rules-grid">
      <section className="card rules-card">
        <p className="eyebrow dark">Individuellt</p>
        <h2>Resultat som räknas</h2>
        ...
        <table className="rules-table"><thead><tr><th>Deltävlingar</th><th>Resultat som stryks</th></tr></thead><tbody>
          <tr><td>3</td><td>0</td></tr>
          <tr><td>4</td><td>1</td></tr>
          <tr><td>5–7</td><td>2</td></tr>
          <tr><td>8–10</td><td>3</td></tr>
          <tr><td>11–14</td><td>4</td></tr>
        </tbody></table>
        <p>För att vara kvalificerad för pris ska åkaren ha deltagit i minst <strong>3 deltävlingar</strong>.</p>
      </section>

      <section className="card rules-card">
        <p className="eyebrow dark">Poäng</p>
        <h2>Poäng per deltävling</h2>
        <div className="table-scroll"><table className="rules-table"><thead><tr><th>Placering</th><th>Poäng</th></tr></thead><tbody>
          {placementPoints.map(([place, points]) => <tr key={place}><td>{place}</td><td><strong>{points}</strong></td></tr>)}
        </tbody></table></div>
        <p className="rules-callout"><strong>Öppen Klass:</strong> varje giltigt deltagande ger 1 deltagarpoäng oavsett placering.</p>
      </section>

      <section className="card rules-card">
        <p className="eyebrow dark">Placering</p>
        <h2>Region och skiljekriterier</h2>
      ...
      <section className="card rules-card">
        <p className="eyebrow dark">Klubbkamp</p>
        <h2>Klubbarnas poängliga</h2>
      ...
      <section className="card rules-card">
        <p className="eyebrow dark">Klubbkamp</p>
        <h2>Medaljligan</h2>
        <p>Medaljligan är en separat klubbtävling. Medaljer från samtliga giltiga deltävlingar räknas och ger medaljpoäng:</p>
        <div className="medal-points" aria-label="Medaljpoäng">
          <div><span>🥇</span><strong>Guld</strong><small>3 poäng</small></div>
          <div><span>🥈</span><strong>Silver</strong><small>2 poäng</small></div>
          <div><span>🥉</span><strong>Brons</strong><small>1 poäng</small></div>
        </div>
        <p>Placeringen avgörs först av flest <strong>medaljpoäng</strong>, därefter flest guld och sedan flest silver. Om klubbar fortfarande är lika blir placeringen delad.</p>
        <p><strong>Öppen Klass ger inga medaljer eller medaljpoäng.</strong></p>
      </section>

      <section className="card rules-card">
        <p className="eyebrow dark">Rullskidskytte</p>
        <h2>Utrustning</h2>
    ...
    <section className="card rules-source">
    ...
    <p className="rules-back"><Link className="text-link" href="/">← Till cupställningen</Link></p>
  </>;
}
